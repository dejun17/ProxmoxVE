...
Official discussion: [GitHub #8126](https://github.com/dejun17/ProxmoxVE/discussions/8126)
...
1. Open an issue on [GitHub](https://github.com/dejun17/ProxmoxVE/issues)
2. Include:
   - Exit code number
   - Error message
   - Steps to reproduce
